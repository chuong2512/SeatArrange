...
namespace Assets.TJ.Scripts
{
	public class CoinsManager : Singleton<CoinsManager>
	{
		...
		private void Start()         { UpdateCoinTxt(); }
		public  int  GetTotalCoins() { return PlayerPrefs.GetInt(PlayerPrefsManager.TotalCoins,0); }
		...
		public void DeductCoins(int amount)
		{
			...
			PlayerPrefs.SetInt(PlayerPrefsManager.TotalCoins,coins);
			UpdateCoinTxt();
			GameDataManager.Instance.playerData.onChangeDiamond?.Invoke(0);
		}
