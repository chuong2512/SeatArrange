...
namespace TJ.Scripts
{
	public class LevelManager : MonoBehaviour
	{
		...
		public static int GetCurrentSceneBuildIndex() { return SceneManager.GetActiveScene().buildIndex; }
		...
		public static void LoadLevel(int levelIDX) { SceneManager.LoadScene(levelIDX); }
